...
#
# > **2ª mitad del hilo del proyecto.** Este documento es la contraparte *predictiva* (desfase T-1)
# > del maestro *contemporáneo* `modelo_contemporaneo_simce.py` (asociación, mismo año). Juntos cubren
# > los dos marcos temporales pedidos por el profesor. Corre **100% local** (figuras a PNG).
#
...
FIG_DIR = Path(__file__).resolve().parents[2] / "reports" / "figuras_predictivo"  # src/modelado/<archivo>.py -> raíz
